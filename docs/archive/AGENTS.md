...
Build complete, testable slices within the active roadmap phase. Do not scaffold all future modules "for completeness." Phase 5 (the grade and transcript engine) is the central value proposition of the Version 1 MVP; earlier data and API decisions must support it without prematurely implementing its UI or leaking into Version 2 features (like Payroll or Timetables).
