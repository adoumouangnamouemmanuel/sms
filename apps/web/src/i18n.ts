    ...
    translation: {
      ...
      configuration: {
        ...
        grading: {
          ...
          empty: 'Aucune politique de notation. La saisie des notes reste bloquée tant qu\u2019aucune politique n\u2019est publiée.',
          emptyCta: 'Créer une politique',
          select: 'Sélectionnez une politique pour la modifier.',
          version: 'Version {{version}}',
          scopeCount: '{{count}} périmètre(s)',
          publishedNote: 'Cette politique est publiée et immuable. Créez une nouvelle version pour la modifier.',
          ...
          scaleMaxHint: "Toutes les notes (devoirs, compositions…) utilisent ce barème. Changer ce nombre met à jour chaque type de note.",
          typesTitle: 'Types de notes',
          derivedTitle: 'Résultats dérivés',
          derivedEmpty: 'Aucun résultat dérivé. Les moyennes intermédiaires (ex. moyenne des devoirs) se créent ici.',
          ...
          scopesHint: 'Résolution : politique par défaut de l\u2019école → niveau → niveau + matière.',
          ...
          create: 'Créer',
          templateHint: 'Les modèles sont des points de départ modifiables — jamais des réglages automatiques.',
        ...
        appreciation: {
          ...
          empty: 'Aucune échelle d\u2019appréciation. Les bulletins restent bloqués tant qu\u2019aucune échelle n\u2019est publiée.',
          version: 'Version {{version}}',
          scale: 'Barème /{{scale}}',
          edit: 'Modifier',
          ...
          name: 'Nom',
          scaleMax: 'Barème maximum',
          scaleMaxHint: 'Doit correspondre au barème de la politique de notation publiée (ex. /20) pour que les moyennes officielles tombent dans les bonnes tranches.',
          ...
          saveDraft: 'Enregistrer le brouillon',
          publish: 'Publier',
          publishedNote: 'Cette échelle est publiée et immuable. Créez une nouvelle version pour la modifier.',
        },
        cancel: 'Annuler',
