    ...
    translation: {
      ...
      imports: {
        ...
        confirm: {
          ...
          identifierHint:
            'Choisissez un identifiant unique (ex. rentree-2026-09-01). Le même identifiant ne peut être importé qu’une seule fois.',
    ...
    translation: {
      ...
      imports: {
        ...
        confirm: {
          ...
          identifierHint:
            'اختر معرّفاً فريداً (مثال: rentree-2026-09-01). لا يمكن استيراد نفس المعرّف إلا مرة واحدة.',
    ...
    translation: {
      ...
      imports: {
        ...
        confirm: {
          ...
          identifierHint:
            'Pick a unique identifier (e.g. rentree-2026-09-01). The same identifier can only be imported once.',
